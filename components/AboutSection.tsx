            ...
            <div className="max-w-7xl mx-auto px-4 ">
                ...
                <div className="grid lg:grid-cols-2 gap-10 items-center">
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Heading */}
                        <h3 className="text-3xl sm:text-4xl font-bold leading-tight text-gray-900">
                            Laptop repair services in Chennai <br />
                            <span className="bg-gradient-to-r from-[#101242] to-[#821616] bg-clip-text text-transparent">
                                @ ₹199
                            </span>
                        </h3> 
                        ...
                        <p className="text-sm font-semibold text-gray-500 uppercase tracking-wider pt-2">
