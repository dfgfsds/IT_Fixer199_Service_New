          ...
          <div className="space-y-6">
            {!submitted ? (
              <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-3 py-4 px-6 rounded-2xl bg-[#101242] hover:bg-[#600000] text-white font-bold transition-all shadow-xl shadow-[#101242]/20 hover:shadow-[#101242]/30 hover:-translate-y-0.5"
                >
                  Send Reset Link
              ...
              <div className="text-center space-y-6 py-4">
                ...
                <button
                  ...
                  className="text-[#101242] font-bold hover:underline"
                >
            ...
            <div className="pt-4 border-t border-slate-50">
              <Link href="/login" className="flex items-center justify-center gap-2 text-slate-500 font-bold hover:text-[#101242] transition-colors group">
